...
**Tech:** GitHub API, Node.js, Express, MongoDB

* Recommends issues based on user’s experience and tech stack
...
**Tech:** MERN, Docker, FastAPI, Cerebras API

* Summarizes emails, assigns tags, and prioritizes based on importance
* Helps user focus on important emails
  [View Project](https://github.com/SidoIndeedo/objective_email)
